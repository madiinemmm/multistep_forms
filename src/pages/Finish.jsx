    ...
    <div className="w-[940px] flex p-4 rounded-2xl mt-4 h-[560px] m-auto bg-white">
      ...
      <div className="p-10 ml-7 flex flex-col justify-between flex-grow">
        ...
        <div className="mt-9 p-4 bg-[#F9F9FD] rounded-lg">
          <h3 className="text-[#022959] font-[700] text-[18px]">
            Plan Details
          </h3>
          <div className="mt-4 flex justify-between text-[#022959]">
            <div>
              <p className="font-[500]">
                {plan?.plan} ({plan?.billing} billing)
              </p>
              <p
                className="text-[#9699AA] cursor-pointer"
                onClick={() => navigate("/select")}>
                Change
              </p>
            </div>
          ...
          <h3 className="text-[#022959] font-[700] text-[18px] mt-6">
            Add-Ons
          </h3>
            ...
            {Object.keys(selectedAddOns).map(
              (addOn) =>
                selectedAddOns[addOn] && (
                  <div
                    key={addOn}
                    className="flex justify-between text-[#022959]">
                    <p className="font-[500]">
                      {addOn === "online"
                        ? "Online Service"
                        : addOn === "storage"
